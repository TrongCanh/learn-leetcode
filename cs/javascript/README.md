...
1. **Đọc README chương trước** → hiểu roadmap của chương đó
2. **Làm từng bài** — mỗi bài đủ nội dung để đọc độc lập
3. **Thực hành** — gõ lại code, thử biến thể
4. **So sánh** — đọc phần " sai lầm phổ biến" kỹ
5. ** Ôn tập** — highlight phần "phỏng vấn hay hỏi" để đọc lại
